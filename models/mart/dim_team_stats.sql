...
final as (
    select
        ...
        max(value_count) filter (where type = 'Corners') as corners_count,
        ...
        max(value_all_count) filter (where type = 'Team Wins') as team_wins_count,
        max(value_all_average) filter (where type = 'Team Wins') as team_wins_average,
        max(value_home_average) filter (where type = 'Team Wins') as team_wins_home_average,
        max(value_away_average) filter (where type = 'Team Wins') as team_wins_away_average,
        max(value_all_count) filter (where type = 'Team Draws') as team_draws_count,
